...
class Projects{
	public function getProjectList()
	{
		// here goes some hardcoded values to simulate the database
		return array(
			"Asteroids" => new Project("Asteroids", "<img src='img/asteroid250.png' class='projectImg picLeft' alt='JS Asteroids'/><p>What started as a simple lesson with my kids on Object Oriented Programming (OOP) eventually morphed into a full blown arcade classic. Based on the vector based Atari classic, we rebuild the game dynamics in HTML5 and JS (ES6). Each game piece is its own div, we leveraged SVG’s to keep the graphics crisp when we scaled them. We wrote our own game engine to updated all the piece and check for collisions. We got lucky and found the original <a href='http://www.classicgaming.cc/classics/asteroids/sounds' target='_blank'>game sounds</a> on line. Updated the styles to make it a little more colorful. Craziest lesson learned was that the entire game code is smaller that the background graphic.</p>", "asteroids100b.png","http://logikbox.com/asteroids/"),
			
			"Satelite Tracker" => new Project("Satelite Tracker", "<img src='img/satelite250.png' class='projectImg picLeft' alt='JS Staelite tracker'/><p>I have 2.5 hobbies, Astronomy and Coding (the .5 is cooking but its also sort of a necessity). Last summer my boys and I were trying to get a photo of the ISS as it flew over our area. After several missed attempts we got serious and started looking it up, mapping its trajectory and we finally decided to code it up in out own project. We hammered this one out in a weekend, they learned the hard lessons of dirty data and how to clean it. You should have seen their faces when I made them sit down in from of Excel and go through our downloaded data. We located some resources on line to get <a href='http://www.n2yo.com' target='_blank'>satellite data</a> via ajax. Though we were only able to get 300 secs of flight data we made it work. Leveraging Google maps and few open API’s we were able to construct a tracker of most of the know orbital bodies flying over head. We are currently working on v2.0, watch this space for updates.</p>", "satelite100.png","https://securec48.ezhostingserver.com/logikbox-com/satellite/"),
			
			"Word Clock" => new Project("Word Clock", "<img src='img/clock250.png' class='projectImg picLeft' alt='Word Clock'/><p>This was one of the first coding projects I did with my oldest son. After trying to explain what Dad does at work I decided to show him. Simple little HTML demos turn into the the project that every engineer does one in their lifetime. This one is mine. Written in HTML5, Javascript and CSS 3 we worked out the layout, figured out all the edge cases and built out out clock that is stilled used on the cracked iPad in the family as the family clock. </p> ","clock100b.png","http://logikbox.com/clock/"),
			
			"Costume Generator" => new Project("Costume Generator", "<img src='img/costume250.png' class='projectImg picLeft' alt='Word Clock'/><p>This was a fun project I did at a previous job. We were working with Goodwill to promote their Halloween sales. We got to plan and build a simple costume generator that you can choose the simple thing you have and build an outfit for the holidays. Half the funds taking the photos of my team mates all dressed up. Built in HTML5, with PHP backend, Javascript and CSS 3 we were able to deliver a tool that local Goodwill franchises could pull into their sites via a simple  Javascript code and rebrand it locally. The tools was a huge success and help drive sales for their busiest time of the year.</p> ","costume100.png","http://dev.deardorffassociates.com/costume-generator/"),

			"World Cup RSS" => new Project("World Cup RSS", "<img src='img/worldcup250.png' class='projectImg picLeft' alt='Word Clock'/><p>This was a mash up that I did in under an hour a few years back. Since we couldn’t get the World Cup on at the office we ran this in its place to keep the fans up on the latest happens with all the matches. Written in PHP with jQuery and CSS, we were able to tap into FIFA’s official press pool feed and spin up the official summaries, stores and press photos in real time and cycle through then for the entire tournament. </p>","worldcup100.png","http://logikbox.com/phprss/")		  	
