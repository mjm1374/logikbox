...
class Projects{
	public function getProjectList()
	{
		...
		return array(
			...
			"Mural Arts Finder" => new Project("Mural Arts Finder", "<p>During the the Brownstein Group’s 50th anniversary we ran a program called Brownstein Gives Back. Each team was challenged to come up with a way to give back to our community. We had been working with the Mural Arts program in Philadelphia and I came up with the idea to leverage an existing database Mural Art had, we developed an app to guide people through the city to see and learn about the murals. The app was location aware, we developed a light Restful API to talk to Mural Arts DB. The data was sketchy, so we create a way for user to take and submit photo’s to update the data. They could even report damage. We later took the app and enabled it on their website and still work with your mobile device. </p>", "mural100.png","mural250.png","https://map.muralarts.org/"),
