...
class Controller {
	...
	public function get_form(){
       ...
       // $msg = trim($msg);
		...
		//$data = '{ "success": true, "challenge_ts": "2018-11-17T21:05:04Z", "hostname": "localhost", "score": 0.9, "action": "email_forms" }';
		//$data = '{"success": false,"race": "Human"}';
		//$character = json_decode($data,true);
		//echo "data: " . $character['success'] . "<hr>";
		//echo "capt: " . $result['success'] . " - " . isset($result['success']). "<hr>";
		//echo var_dump($result);
		//$data = json_decode($recaptcha_response);
 
		if(isset($result['success'] ) &&  $result['success'] == 1) {

             print_r("Thanks for reaching out. I'll get back to you."); exit;
